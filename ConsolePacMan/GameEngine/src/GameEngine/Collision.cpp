...
bool GameEngine::Collision::AABB(const glm::vec2& pos1, const glm::vec2& size1, const glm::vec2& pos2, const glm::vec2& size2)
{
...
bool GameEngine::Collision::AABB(const ColliderComponent& colA, const ColliderComponent& colB)
{
